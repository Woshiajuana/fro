...
/// 自定义可点击效果构建器
typedef FroClickableBuilder = Widget Function(WidgetState? state, Widget child);

class FroClickable extends StatefulWidget {
  final Widget child;
  final bool disabled;
  ...
  final FroClickableBuilder? builder;
  ...
  @override
  State<FroClickable> createState() => _FroClickableState();
}

class _FroClickableState extends State<FroClickable> {
  WidgetState? _state;
  late bool _disabled;
  late bool _clickable;
  late bool _withColor;
  late FroClickableBuilder builder;
  ...
  Widget build(BuildContext context) {
    ...
    return FroClickableGestureDetector(
      onTap: widget.onTap,
